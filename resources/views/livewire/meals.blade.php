<div class="container mt-4 mb-4 bg-white shadow-sm rounded-lg" style="border: 1px solid grey;">
                ...
                <div class="form-group w-100">
                    ...
                    <select wire:model.defer="teacher" class="form-control" id="exampleFormControlSelect1">
                        ...
                        @foreach ($teachers as $teacher)
                            <option value="{{ $teacher }}" wire:click="setTeacher">
    ...
    @if ($showStudentMealPlanLogger)
        <div class="row">
            @foreach ($students as $student)
                <div class="col-lg-4">
                    <table class="table table-bordered border-primary" wire:ignore.this>
                        <thead>
                            <tr>
                                <th colspan="4" class="mx-auto">{{$full_date['day']}} {{$full_date['month']}} {{$full_date['year']}}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <input class="mx-auto" type="radio" name="{{$student->id}}1" wire:click="addMeal({{$i}}, 'breakfast', {{$student->id}})">
                                    </div>
                                </td>  
                                @endfor
                            </tr>
                            <tr>
                                ...
                                @for ($i = 1; $i <= 3; $i++)
                                    <td>
                                        <div class="row">
                                            <input class="mx-auto" type="radio" name="{{$student->id}}2" wire:click="addMeal({{$i}}, 'water', {{$student->id}})">
                                        </div>
                                    </td>  
                                @endfor  
                            </tr>
                            <tr>
                                ...
                                @for ($i = 1; $i <= 3; $i++)
                                    <td>
                                        <div class="row">
                                            <input class="mx-auto" type="radio" name="{{$student->id}}3" wire:click="addMeal({{$i}}, 'vegetables', {{$student->id}})">
                                        </div>
                                    </td>  
                                @endfor
                            </tr>
                            <tr>
                                ...
                                @for ($i = 1; $i <= 3; $i++)
                                    <td>
                                        <div class="row">
                                            <input class="mx-auto" type="radio" name="{{$student->id}}4" wire:click="addMeal({{$i}}, 'protein', {{$student->id}})">
                                        </div>
                                    </td>  
                                @endfor 
                            </tr>
                            <tr>
                                ...
                                @for ($i = 1; $i <= 3; $i++)
                                    <td>
                                        <div class="row">
                                            <input class="mx-auto" type="radio" name="{{$student->id}}5" wire:click="addMeal({{$i}}, 'carbohydrate', {{$student->id}})">
                                        </div>
                                    </td>  
                                @endfor
                            </tr>
        ...
        <div class="row ml-3 mb-3">
            ...
            <a class="btn btn-primary ml-3" wire:click="exportMeals({{$aDay}})">Print</a>
        </div>
    @endif
</div>
