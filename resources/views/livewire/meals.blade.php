<div class="container mt-4 mb-4 bg-white shadow-sm rounded-lg" style="border: 1px solid grey;">
                    ...
                    <table class="table table-bordered border-primary" wire:ignore.this>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <input class="mx-auto" type="radio" name="{{$student->id}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <input class="mx-auto" type="radio" name="{{$student->id.'1'}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <input class="mx-auto" type="radio" name="{{$student->id.'2'}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <input class="mx-auto" type="radio" name="{{$student->id.'3'}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <input class="mx-auto" type="radio" name="{{$student->id.'4'}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="row">
    ...
    {{-- Modals - This will have to be scrapped, and the data hidden with a variable, and then shown when the variable proves true. This is because
        due to the way the code is set up, I cannot update the students because of how the wire:ignore works
    --}} 
    @foreach ($day as $index => $aDay)
                                ...
                                @foreach ($students as $student)
                                    <div class="col-lg-4">
                                        <table class="table table-bordered border-primary" wire:ignore.this>
                                            <thead>
                                                <tr>
                                                    <th colspan="4">{{$aDay}} {{$index + 1}} {{$months[$display_month - 1]}} {{$year}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
