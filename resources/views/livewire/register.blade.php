<div>
    ...
    <div class="row mt-4">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1"}>
                        @foreach($months as $month)
                            <option wire:click="setMonth('{{$month}}')">{{$month}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1"}>
                        @for($i=2021; $i<=2030; $i++)
                            <option wire:click="setYear('{{$i}}')">{{$i}}</option>
                        @endfor
                    </select>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div style="width: 100%;">
                ...
                <button type="button" class="w-100 btn btn-success mt-5" wire:click="getStudents">Go</button>
            </div>

        </div>
        <div class="col-lg-4">
            <img class="float-right" style="width: 70%;" src="{{asset('storage\img\register.jpg')}}" alt="" srcset="">
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            <button type="button" class="btn btn-lg shadow" style="width: 5%; height: auto; background-color:#ab6369; border: 1px solid black; height: 100%;"  data-toggle="modal" data-target="#adminPasswordModal" {{$showAdminEditToolsButton}}>
            ...
            @if($adminToolsFlipFlop == true)
                <button type="button" class="btn btn-lg shadow" style="width: 5%; height: auto; background-color:#2d6d46; border: 1px solid black; height: 100%;" data-toggle="modal" data-target="#teacherAddModal">
            ...
            <button type="button" class="btn btn-lg shadow float-right" style="width: 5%; height: auto; color: #ffffff; background-color: #ab6369; border: 1px solid black;font-family: 'Orelega One', cursive;">
            ...
            <button type="button" class="btn btn-lg shadow float-right mr-1" style="width: 5%; height: auto; color: #ffffff; background-color: #ab6369; border: 1px solid black;font-family: 'Orelega One', cursive;" wire:click="showUserEditTools">{!!$arrowPointing!!}</button>

            @if($userToolsFlipFlop == true)
                <button type="button" class="btn btn-lg shadow float-right mr-1" style="width: 5%; height: auto; background-color:red; border: 1px solid black;  height: 100%;"  height: 100%; wire:click="" data-toggle="modal" data-target="#studentDeleteModal">
                ...
                <button type="button" class="btn btn-lg shadow float-right mr-1" style="width: 5%; height: auto; background-color:yellow; border: 1px solid black;  height: 100%;" wire:click="" data-toggle="modal" data-target="#studentEditModal">
                    <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h274.9c-2.4-6.8-3.4-14-2.6-21.3l6.8-60.9 1.2-11.1 7.9-7.9 77.3-77.3c-24.5-27.7-60-45.5-99.9-45.5zm45.3 145.3l-6.8 61c-1.1 10.2 7.5 18.8 17.6 17.6l60.9-6.8 137.9-137.9-71.7-71.7-137.9 137.8zM633 268.9L595.1 231c-9.3-9.3-24.5-9.3-33.8 0l-37.8 37.8-4.1 4.1 71.8 71.7 41.8-41.8c9.3-9.4 9.3-24.5 0-33.9z"/></svg>
                </button>

                <button type="button" class="btn btn-lg shadow float-right mr-1" style="width: 5%; height: auto; background-color:rgb(59, 196, 59); border: 1px solid black;  height: 100%;" wire:click="" data-toggle="modal" data-target="#studentAddModal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="" placeholder="" wire:model.defer="teacherName">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="" placeholder="" wire:model.defer="teacherSurname">
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="" placeholder="" value="{{$teacherName}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-3">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select multiple class="form-control" id="exampleFormControlSelect2" size="8">
                                    @foreach ($students as $student)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="" placeholder="" autocomplete="false">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="" placeholder="" autocomplete="disabled">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
