<div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-4">
            <div style="width: 100%;">
                ...
                <button type="button" class="w-100 btn btn-success mt-5" wire:click="getAttendanceRecords">Go</button>
            </div>

        </div>
        <div class="col-lg-4">
            <img class="mx-auto d-block" style="width: 70%;" src="{{asset('storage\img\register.jpg')}}" alt="" srcset="">
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            ...
            <button wire:click="export" type="button" class="btn btn-lg shadow float-right" style="width: 5%; height: auto; color: #ffffff; background-color: #7c63ab; border: 1px solid black;font-family: 'Orelega One', cursive;">
            ...
            <button type="button" class="btn btn-lg shadow float-right mr-1" style="width: 5%; height: auto; background-color:#ab6363; border: 1px solid black;  height: 100%;"  height: 100%; wire:click="" data-toggle="modal" data-target="#studentDeleteModal">
...
`
            <button type="button" class="btn btn-lg shadow float-right mr-1" style="width: 5%; height: auto; background-color:#aaab63; border: 1px solid black;  height: 100%;" wire:click="" data-toggle="modal" data-target="#studentEditModal">
                <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h274.9c-2.4-6.8-3.4-14-2.6-21.3l6.8-60.9 1.2-11.1 7.9-7.9 77.3-77.3c-24.5-27.7-60-45.5-99.9-45.5zm45.3 145.3l-6.8 61c-1.1 10.2 7.5 18.8 17.6 17.6l60.9-6.8 137.9-137.9-71.7-71.7-137.9 137.8zM633 268.9L595.1 231c-9.3-9.3-24.5-9.3-33.8 0l-37.8 37.8-4.1 4.1 71.8 71.7 41.8-41.8c9.3-9.4 9.3-24.5 0-33.9z"/></svg>
            </button>

            <button type="button" class="btn btn-lg shadow float-right mr-1" style="width: 5%; height: auto; background-color:#63ab87; border: 1px solid black;  height: 100%;" wire:click="" data-toggle="modal" data-target="#studentAddModal">
