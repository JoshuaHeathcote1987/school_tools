<div class="container mt-4 mb-4 bg-white shadow-sm rounded-lg" style="border: 1px solid grey;">
    ...
    @if($teacherStudentFlipFlop)
        ...
        <div class="row">
            <div class="col-lg-12 px-0 mx-0">
                <button wire:click="export" type="button" class="btn btn-lg mr-3 mb-2 float-right" style="background-color:#7c63ab; border: 1px solid black;">
                ...
                <button type="button" class="btn btn-lg mr-2 mb-3 float-right" style="background-color:#65ab63; border: 1px solid black;" data-toggle="modal" data-target="#addStudent">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#showSwapStudentModal" wire:click="setStudent('{{$student->id}}')">     
    ...
    <form autocomplete="off">
        <div class="modal fade" id="showSwapStudentModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #bee5eb; border-bottom: 1px solid #404040;">
                        <h5 class="modal-title" id="exampleModalLabel">Swap Student</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" data-dismiss="modal" wire:click="swapStudent()">Swap</button>
                    </div>
                </div>
            </div>
        </div>                                                                                          
